...
def query_openrouter_api(prompt):
    ...
    for selected_model in models_to_try:
        system_prompt = (
            ...
            "⚠️ КРИТИЧЕСКОЕ ПРАВИЛО: Каждый твой ответ ОБЯЗАТЕЛЬНО должен содержать две четкие секции:\n"
            ...
            "2. 👉 **Решение:** (Твой итоговый краткий, практический и полезный ответ Денису).\n"
