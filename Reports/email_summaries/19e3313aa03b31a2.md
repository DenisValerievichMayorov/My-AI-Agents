# Email Summary: [DenisValerievichMayorov/My-AI-Agents] Google API Key exposed on GitHub

**From:** GitGuardian <security@getgitguardian.com>
**Date:** Sat, 16 May 2026 23:16:26 +0000
...
<head>
    ...
    <title>[DenisValerievichMayorov/My-AI-Agents] Google API Key exposed on GitHub</title>
    <style type="text/css">
            ...
            <td class="container" width="600"
                ...
                <div class="content" style="max-width: 600px; display: block; margin: 0 auto; padding: 25px">
                    <table class="main" width="100%" cellpadding="0" cellspacing="0" style="border-radius: 5px; background-color: #fff; margin: 0" bgcolor="#ffffff">
                        ...
                        <tr style="margin: 0">
                            <td style="vertical-align: top; margin: 0; padding: 15px 25px 20px...